...
<!-- Stats Cards -->
                ...
                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ $totalProjects }}</p>
                            </div>
                ...
                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ $activeProjects }}</p>
                            </div>
                ...
                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ $completedProjects }}</p>
                            </div>
            <div class="p-3 rounded-full bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-400">
                ...
                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ number_format($averageProgress, 0) }}%</p>
                            </div>
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <form action="{{ route('projects.index') }}" method="GET" class="filter-form grid grid-cols-1 md:grid-cols-5 gap-4">
