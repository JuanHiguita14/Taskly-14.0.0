...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ $totalTasks }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ $pendingTasksCount }}</p>
                            </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ $completedTasksCount }}</p>
                            </div>
                ...
                <p class="text-2xl font-bold mt-1 text-gray-900 dark:text-white">{{ $overdueTasksCount }}</p>
                            </div>
    ...
    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
        <form action="{{ route('tasks.index') }}" method="GET" class="filter-form grid grid-cols-1 md:grid-cols-5 gap-4">
        ...
        <div class="task-item p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200 {{ $task->priority }}_priority">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    @if(!(auth()->user()->role === 'student' && $task->teacher_id !== null))
