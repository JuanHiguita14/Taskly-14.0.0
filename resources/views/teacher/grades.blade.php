...
<div class="mb-6">
    ...
    <div class="mt-4">
        <form action="{{ route('teacher.grades') }}" method="GET" class="w-full max-w-md ml-auto">
            <div class="relative">
                <input type="text" name="q" value="{{ request('q') }}" placeholder="Buscar por título, descripción o estudiante..." class="w-full pl-10 pr-3 py-2 rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500">
