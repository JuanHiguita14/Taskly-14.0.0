        ...
        <div class="p-6 hover:bg-gray-50 dark:hover:bg-gray-700 transition-all duration-200">
            <div class="flex items-center justify-between">
                                    ...
                                    <div class="w-72">
                                        @if($t->grade !== null)
                                            <div class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded p-2">
                                                ...
                                                <p class="text-lg font-bold text-green-600 dark:text-green-300">{{ number_format($t->grade, 1) }}/100</p>
                                                @if($t->feedback)
                                        ...
                                        @else
                                            <form onsubmit="return gradeSubtask(event, {{ $project->id }}, {{ $t->id }})" class="bg-gray-50 dark:bg-gray-700 rounded p-2 border border-gray-200 dark:border-gray-600">
                                                ...
                                                <input type="number" name="grade" min="0" max="100" step="0.1" required class="w-full mb-1 rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white focus:border-indigo-300 focus:ring focus:ring-indigo-200">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 rounded-lg px-4 py-2">
                        <div class="text-center">
                            <p class="text-xs font-medium text-indigo-800 dark:text-indigo-200">Calificación Final</p>
                            <p class="text-xl font-bold text-indigo-600 dark:text-indigo-300">{{ number_format($averageGrade, 1) }}/100</p>
                            <p class="text-xs text-indigo-600 dark:text-indigo-400">
                                Promedio de {{ $gradedSubtasks->count() }} subtarea(s)
                            </p>
                        </div>
                    </div>
                    @endif
