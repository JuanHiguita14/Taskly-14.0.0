                ...
                <div class="flex items-center justify-between px-6 py-4">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <button class="relative p-2 text-gray-400 hover:text-gray-500 dark:hover:text-gray-300">
                            ...
                            <span class="absolute -top-1 -right-1 h-4 w-4 bg-red-500 text-white text-xs rounded-full flex items-center justify-center {{ auth()->user()->unreadNotifications()->count() > 9 ? 'px-1' : '' }}">
