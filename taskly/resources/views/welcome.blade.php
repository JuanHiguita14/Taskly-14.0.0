                    ...
                    <div class="relative max-w-md">
                        ...
                        <div class="absolute -top-6 -right-6 bg-white p-4 rounded-lg shadow-lg z-10">
                            <div class="text-center">
                                <p class="font-bold text-lg gradient-text2">90%</p>
            ...
            <div class="flex flex-col items-center">
                ...
                <div class="w-full max-w-4xl rounded-xl overflow-hidden shadow-2xl relative">
                    <div class="aspect-w-16 aspect-h-9 bg-gray-200 flex items-center justify-center">
                        <button onclick="window.open('https://www.youtube.com/watch?v=eFcbPBQ-AfM&list=RDeFcbPBQ-AfM&start_radio=1', '_blank')" class="play-button" style="width: 80px; height: 80px; background: linear-gradient(45deg, #4F46E5, #06B6D4); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 10px 25px rgba(79, 70, 229, 0.3);">
        ...
        <div class="container mx-auto px-6">
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <p class="text-gray-400">taskly@gmail.com</p>
                </div>
            </div>
